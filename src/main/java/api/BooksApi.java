...
public class BooksApi {
    ...
    public static Response editBook(HashMap<String,Object> bookDetails, String accessToken)
    {
        RequestSpecification request = given().contentType(ContentType.JSON).log().all();
    ...
    public static Response getBookInfoById(HashMap<String,Object> bookDetails, String accessToken)
    {
        RequestSpecification request = given().contentType(ContentType.JSON).log().all();
    ...
    public static Response deleteBookById(String id, String accessToken)
    {
        RequestSpecification request = given().contentType(ContentType.JSON).log().all();
